...
<?php
$fecha = new DateTime();
echo $this->Form->create('Activity', array('url'=>array('action'=>'edit'),'class'=>'center','type'=>'file'));
?>
<table width="100%">
    <thead>
        <td width="100%">
...
echo $this->Html->link('Regresar', array('controller' => 'activities', 'action' => 'index'));
